defmodule NewWorldWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(NewWorldWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(NewWorldWeb.Gettext, "errors", msg, opts)
    end
  end
